  ...
  return (
    <>
      ...
      {!hasError ? (
        ...
        <h1 className="text-3xl text-center font-semibold text-gray-800 p-2 bg-yellow-200 rounded-lg shadow-lg ">
          Related Products are not on stock for this category
        </h1>
      )}
    </>
  );
